...
// Fetch reception images from the decorations table
...
<head>
    ...
    <title>Reception Decorations - Celebratory Canvas</title>
...
<body>
    ...
    <!-- Sangeet Gallery Section -->
    <section id="decorations-themes" class="py-5">
        <div class="container">
            <p id="p2">Our Decorations For Reception</p>
            <div class="filter-wrapper">
                <form method="GET" class="filter-bar">
                    ...
                    <!-- RESET -->
                    <a href="reception.php" class="reset-btn">Reset</a>
