...
// Fetch haldi images from the decorations table
...
<head>
    ...
    <title>Haldi Decorations - Celebratory Canvas</title>
...
<body>
    ...
    <section id="decorations-themes" class="py-5">
        <div class="container">
            <p id="p2">Our Decorations For Haldi</p>
            ...
            <div class="filter-wrapper">
                <form method="GET" class="filter-bar">
                    ...
                    <!-- RESET -->
                    <a href="haldi.php" class="reset-btn">Reset</a>
