...
<head>
    ...
    <title>Sangeet Decorations - Celebratory Canvas</title>
...
<body>
    ...
    <section id="decorations-themes" class="py-5">
        <div class="container">
            <p id="p2">Our Decorations For Sangeet</p>
            ...
            <div class="filter-wrapper">
                <form method="GET" class="filter-bar">
                    ...
                    <!-- RESET -->
                    <a href="sangeet.php" class="reset-btn">Reset</a>
            ...
            <div class="showcase">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "No sangeet decorations available.";
                }
                ?>
            </div>
        </div>
